...
/**
 * Returns the first reason a method's transitive request/response closure is
 * outside openbindings.grpc@1 §3, or undefined when the closure is admitted.
 * protobufjs resolves inherited Editions features onto reflection objects;
 * those values are intentionally inspected here because the binding range is
 * defined on the resolved descriptor semantics, not source spelling.
 */
